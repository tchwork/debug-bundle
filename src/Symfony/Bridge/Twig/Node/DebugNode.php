 ...
 *
 * @deprecated use DumpNode instead
 */
    ...
    public function compile(\Twig_Compiler $compiler)
    {
        ...
        if (null === $values) {
            ...
            $compiler
                ...
                ->write("}\n")
                ->addDebugInfo($this)
                ->write(sprintf('\Symfony\Component\VarDumper\VarDumper::debug($%svars);'."\n", $this->varPrefix))
            ;
        } elseif (1 === $values->count()) {
            $compiler
                ->addDebugInfo($this)
                ->write('\Symfony\Component\VarDumper\VarDumper::debug(')
            ...
            $compiler
                ->addDebugInfo($this)
                ->write('\Symfony\Component\VarDumper\VarDumper::debug(array('."\n")
                ->indent()
            ;
